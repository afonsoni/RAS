                ...
                <form> 
                    <div className="space-y-12">
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <label htmlFor="nomeAluno" className="block text-sm font-medium leading-6 text-gray-900">
                                Nome
                            </label>
                            <div className="mt-2">
                            ...
                            <div className="sm:col-span-4">
                            <label htmlFor="numAluno" className="block text-sm font-medium leading-6 text-gray-900">
                            ...
                            <div className="sm:col-span-4">
                            <label htmlFor="emailAluno" className="block text-sm font-medium leading-6 text-gray-900">
                                Email
                            </label>
                            <div className="mt-2">
                                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
