...
function DisponibilidadeSalas() {
    ...
    return (
        <><div className="hero min-h-screen bg-base-200 flex items-center justify-center">
                ...
                <div className="card-body text-center">
                    ...
                    <div className="text-left">
                        ...
                        <div className="flex justify-end mt-4">
                            <button className="btn btn-sm" onClick={() => setShowModal4(true)}>Editar Email</button>
                        </div>
            ...
            <Modal isVisable={showModal4} onClose={() => setShowModal4(false)}>
                <div className="p-6">
                    ...
                    <div className="flex justify-center mt-4">
                        ...
                        <button className="btn btn-sm btn-primary" type="button" onClick={handleClick}>Atualizar</button>
                    </div>
                </div>
            </Modal>
        </div></>
